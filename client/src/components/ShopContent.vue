                ...
                <div class="col l-2 m-0 c-0">
                    ...
                    <nav class="category">
                        ...
                        <div class="shop-price-range-filter">
                            <input
                                type="text"
                                class="shop-price-range-filter__input"
                                placeholder="₫ TỪ"
                            />
                        ...
                        <button class="shop-price-range-filter__button">
                            Áp dụng
                        </button>
                    </nav>
                </div>
