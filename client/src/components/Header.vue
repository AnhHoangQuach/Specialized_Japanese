		...
		<div class="grid wide">
				...
				<ul class="header__navbar-list">
					<li class="header__navbar-item header__navbar-item--has-notify">
						<a href="" class="header__navbar-item-link">
							<fa-icon :icon="['fa', 'bell']" class="header__navbar-icon"/>
							Thông báo
						</a>
							...
							<ul class="header__notify-list">
								<li class="header__notify-item">
									<a href="" class="header__notify-link">
										<img src="https://cf.shopee.vn/file/8f37486c0c77530f52d59835bcbc695c_tn" alt="" class="header__notify-img">
								...
								<li class="header__notify-item">
									<a href="" class="header__notify-link">
										<img src="https://cf.shopee.vn/file/8f37486c0c77530f52d59835bcbc695c_tn" alt="" class="header__notify-img">
										<div class="header__notify-info">
											<span class="header__notify-name">Ohui chính thức ra mắt dòng son li mới THE FIRST GENITURE LIPSTICK</span>
					...
					<li class="header__navbar-item">
						<router-link :to="{name: 'Help'}" class="header__navbar-item-link">
							<fa-icon :icon="['fa', 'question-circle']" class="header__navbar-icon"/>
							Trợ giúp
						</router-link>
					</li>
			...
			<div class="header-with-search">
				<div class="header__nav-bars-button">
					...
					<input type="checkbox" hidden name="" id="nav__mobile-input" class="nav__input">
				...
				<label for="mobile-search-checkbox" class="header__mobile-search">
					<fa-icon :icon="['fa', 'search']" class="header__mobile-search-icon"/>
				</label>
				...
				<input type="checkbox" name="" id="mobile-search-checkbox" hidden class="header__search-checkbox">
				...
				<div class="header__cart">
					<div class="header__cart-wrap">
						<fa-icon :icon="['fa', 'shopping-cart']" class="header__mobile-search-icon"/>
