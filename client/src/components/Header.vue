    ...
    <header class="header">
        <div class="grid wide">
            <nav class="header__navbar hide-on-mobile-tablet">
                <ul class="header__navbar-list">
                    ...
                    <li class="header__navbar-item">
                        <span class="header__navbar-item-title--no-pointer"
                            >Kết nối</span
                        >
                        <a
                            href="https://www.facebook.com/profile.php?id=100007422227963"
                        ...
                        <a
                            href="https://www.instagram.com/anhhoang362k/?fbclid=IwAR3dgiZ6tBpPhWm5C958Ei-r919lTF7HQy1iFV20DHBHw3XgDmUSP84pTVU"
                            target="_blank"
                            class="header__navbar-icon-link"
                        >
                            <fa-icon
                ...
                <ul class="header__navbar-list">
                    <li
                        class="
                            header__navbar-item header__navbar-item--has-notify
                        "
                    >
                            ...
                            <ul class="header__notify-list">
                                <li class="header__notify-item">
                                    <a href="" class="header__notify-link">
                                        <img
                                            src="https://cf.shopee.vn/file/8f37486c0c77530f52d59835bcbc695c_tn"
                                            alt=""
                                        ...
                                        <div class="header__notify-info">
                                            ...
                                            <span
                                                ...
                                                "
                                                >HiddenTag là giải pháp xác thực
                                                hàng chính hãng bằng công nghệ
                                                tiên tiến nhất hiện nay</span
                                            >
                                        </div>
                                    </a>
                                </li>
                                <li class="header__notify-item">
                                    <a href="" class="header__notify-link">
                                        ...
                                        <div class="header__notify-info">
                                            <span class="header__notify-name"
                                                >Sale sốc bộ dưỡng Ohui The
                                                First tái tạo trẻ hóa da SALE
                                                OFF 70%</span
                                            >
                                            <span
                                                class="
                                ...
                                <li class="header__notify-item">
                                    <a href="" class="header__notify-link">
                                        ...
                                        <div class="header__notify-info">
                                            <span class="header__notify-name"
                                                >Ohui chính thức ra mắt dòng son
                                                li mới THE FIRST GENITURE
                                                LIPSTICK</span
                                            >
                                            <span
                                                class="
                                                    header__notify-description
                                                "
                                                >Một làn môi căng mềm, quyến rũ
                                                với sắc màu nổi bật luôn là điều
                                                mà các quý cô ao ước</span
                                            >
                                        </div>
                                    </a>
                                </li>
                    ...
                    <li
                        class="header__navbar-item header__navbar-user"
                        v-if="$store.state.user"
                    >
                        <img
                            src="https://graph.facebook.com/2700722880185093/picture?width=400&height=400"
                            alt=""
                        ...
                        <ul class="header__navbar-user-menu">
                            ...
                            <li class="header__navbar-user-item">
                                <router-link :to="{ name: 'UserBill' }"
                                    >Đơn mua</router-link
                                >
                            </li>
                            <li class="header__navbar-user-item">
                                <router-link :to="{ name: 'AddProduct' }"
                                    >Tạo sản phẩm</router-link
                                >
                            </li>
                            <li
                                class="
                    ...
                    <div class="d-flex" v-else>
                        ...
                        >
                            <a
                                class="header__navbar-item-click"
                                @click="openRegister"
                                >Đăng ký</a
                            >
                        </li>
            ...
            <div class="header-with-search">
                <div class="header__nav-bars-button">
                    ...
                    <label for="nav__mobile-input"></label>
                    <input
                        type="checkbox"
                        hidden
                        name=""
                    ...
                    <nav class="nav__mobile">
                        ...
                        <ul class="nav__mobile-list">
                            <li class="nav__mobile-link" id="#form__container">
                                Đăng ký
                            </li>
                            <li class="nav__mobile-link" id="#login">
                                Đăng nhập
                            </li>
                        </ul>
                    </nav>
                ...
                <div class="header__cart">
                    <div class="header__cart-wrap">
                        ...
                        <div class="header__cart-list">
                            <div
                                class="header__cart-list--no-cart"
                                v-if="!carts"
                            >
                                <img
            ...
            <div class="modal__body">
                ...
                <div class="auth-form">
                    ...
                    <div class="auth-form__socials">
                        ...
                        >
                            <i
                                class="auth-form__socials-icon fab fa-google"
                            ></i>
                            <span class="auth-form__socials-title"
        ...
        <div class="modal__login" v-if="state_login">
            ...
            <div class="modal__body">
                ...
                <div class="auth-form">
                    <div class="auth-form__container">
                        <div class="auth-form__header">
                            <h3 class="auth-form__heading" @click="openLogin">
                                Đăng nhập
                            </h3>
                            <span
                                class="auth-form__switch-btn"
